...
from Cpu_components.ternary_gates import (
    ternary_and, ternary_or, ternary_xor,
    ternary_nand, ternary_nor
)
...
def benchmark_genetic_model(model: GeneticNeuralModel, operation: str) -> Dict[str, Any]:
    """Benchmark a genetic neural network implementation of a ternary operation"""
    test_cases = [(a, b) for a in range(3) for b in range(3)]
    times = []
    correct = 0
